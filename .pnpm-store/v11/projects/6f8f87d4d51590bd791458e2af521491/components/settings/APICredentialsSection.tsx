 ...
 * 
 * Credentials are encrypted before storage. Provider runtime integration is
 * reported separately from stored-secret presence.
 */
    ...
    return (
        <Card className="lg:col-span-2">
            <CardHeader>
                ...
                <CardDescription>
                    Store API keys for future ONSIT provider integration. Stored status does not mean
                    the current Intelligence worker can use or reach that provider.
                </CardDescription>
            </CardHeader>
                ...
                <CardContent className="space-y-4">
                    {apiServices.map(service => {
                        ...
                        return (
                            <div
                                key={service.id}
                                className="flex flex-col items-start gap-3 rounded-lg border bg-zinc-50/50 p-4 dark:bg-zinc-900/50 sm:flex-row sm:gap-4"
                            >
                                    ...
                                    <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
                                        <div className="relative flex-1">
                                            ...
                                            <Button
                                                ...
                                                aria-label={`${isShown ? 'Hide' : 'Show'} ${service.name} key being entered`}
                                            >
                                                {isShown ? (
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-blue-600 dark:text-blue-300 mt-1">
                                    New values are protected with authenticated AES-256-GCM encryption at rest and are never returned by this page.
                                    Current ONSIT workers do not yet consume these stored values; provider availability is not checked here.
                                </p>
                            </div>
                        </div>
                    </div>
