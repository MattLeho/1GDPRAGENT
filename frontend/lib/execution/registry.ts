...
export const TASK_DEFINITIONS: readonly TaskDefinition[] = [
    ...
    task('image.origin_classification','Image origin classification','Classify camera, screenshot, downloaded, edited, generated, or unknown origin.','images','personal','image','deterministic_image_origin',['deterministic','local_service','local_model','remote_model']),
    ...
    task('image.caption','Image caption','Describe selected image content.','images','sensitive','image','local_visual',['local_service','local_model','remote_model'],textOutput),
    task('image.landmark_candidate','Landmark candidate','Propose, but do not assert, a landmark match.','images','sensitive','image','local_visual',['local_service','local_model','remote_model']),
...
export const ENGINE_DEFINITIONS: readonly EngineDefinition[] = [
    ...
    { engine_id:'deterministic_image_origin',display_name:'Deterministic image origin',engine_type:'deterministic',provider:'pillow',execution_location:'local',capabilities:['image.origin_classification'],supports_model_discovery:false,adapter:'intelligence_service' },
    ...
    { engine_id:'local_ocr',display_name:'Local OCR',engine_type:'local_service',provider:'tesseract',execution_location:'local',capabilities:['image.ocr','document.ocr'],supports_model_discovery:false,adapter:'intelligence_service' },
    { engine_id:'local_visual',display_name:'Local visual model',engine_type:'local_service',provider:'ollama',execution_location:'local',capabilities:['image.caption','image.landmark_candidate'],supports_model_discovery:true,adapter:'intelligence_service' },
